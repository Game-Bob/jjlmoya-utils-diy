...
const UTILITY_ASSET_ROOT = "/_utilities/diy";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/diy/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/diy/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("diy");
